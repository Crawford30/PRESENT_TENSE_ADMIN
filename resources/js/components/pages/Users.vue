    ...
    <div class="row mt-5" v-if="$gate.isAdmin()">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body table-responsive p-0" v-if="users != null && users != undefined">
                        ...
                        <tbody>
                            ...
                            <tr v-for="(user, index) in users.data" :key="user.id">
                                ...
                                <td>
                                    ...
                                    <a href="#" @click="deleteUser(user.id)" style="margin-left: 8px">
                                        <i class="far fa-trash-alt" style="color: #999; font-size: 18px"></i>
                                    </a>

                                    <a href="#" @click="deleteUser(user.id)" style="margin-left: 8px">
                                        <i class="fa fa-ban" style="color: #999; font-size: 18px"></i>
                                    </a>
                                </td>
                            </tr>
                        </tbody>
