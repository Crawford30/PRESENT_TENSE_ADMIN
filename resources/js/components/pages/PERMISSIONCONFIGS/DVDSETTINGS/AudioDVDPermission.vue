            ...
            <div class="row justify-content-center m-0">
                <div class="table table-sm">
                    ...
                    <form id="permissions-form">
                        <div v-for="(audioDVD, index) in dvdAudios.results" v-bind:key="'audio-dvd-' + audioDVD.id + index" style="width: 100% !important">
                  ...
                  ">
                          ...
                          /> -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col" style="padding: 0rem 2rem !important">
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" :data-user="audioDVD.id" data-group="1" class="custom-control-input" :id="
                                      'permission-audio-dvd-east-africa' +
                                      audioDVD.id
                                    " :name="'permissions[' + audioDVD.id + '][]'" value="audio_eaf" :checked="
                                    ...
                                    "></label>
                                                    ...
                                                    <div class="col" style="padding: 0rem 2rem !important">
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" :data-user="audioDVD.id" data-group="2" class="custom-control-input" :id="
                                      'permission-audio-dvd-india' + audioDVD.id
                                    " :name="'permissions[' + audioDVD.id + '][]'" value="audio_ind" :checked="
                                      audioDVD.audio_dvd_permissions.includes(
                                        'audio_ind'
                                      )
                                    " />
                                ...
                                <div class="custom-control custom-checkbox">
                                  ...
                                  <label class="custom-control-label"></label>
                                                    ...
                                                    <div class="col" style="padding: 0rem 2rem !important">
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" :data-user="audioDVD.id" data-group="3" class="custom-control-input" :id="
                                      'permission-audio-dvd-south' + audioDVD.id
                                    " :name="'permissions[' + audioDVD.id + '][]'" value="audio_saf" :checked="
                                      audioDVD.audio_dvd_permissions.includes(
                                        'audio_saf'
                                      )
                                    " />
                                    ...
                                    "></label>
                                                    ...
                                                    <div class="col" style="padding: 0rem 2rem !important">
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" :data-user="audioDVD.id" data-group="4" class="custom-control-input" :id="
                                      'permission-audio-dvd-europe' +
                                      audioDVD.id
                                    " :name="'permissions[' + audioDVD.id + '][]'" value="audio_eur" :checked="
                                      audioDVD.audio_dvd_permissions.includes(
                                        'audio_eur'
                                      )
                                    " />
                                    ...
                                    "></label>
                                                    ...
                                                    <div class="col" style="padding: 0rem 1.6rem !important">
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" :data-user="audioDVD.id" data-group="5" class="custom-control-input" :id="
                                      'permission-audio-dvd-all' + audioDVD.id
                                    " :name="'permissions[' + audioDVD.id + '][]'" value="audio_all" :checked="
                                      audioDVD.audio_dvd_permissions.includes(
                                        'audio_all'
                                      )
                                    " />
                        ...
                        <div class="text-right mt-4">
                            <button :disabled="isProcessing" @click.prevent="savePermissions" class="present-tense-btn present-tense-primary px-6">
                                <span>
        ...
        savePermissions() {
            ...
            $.ajax({
                ...
                success(data) {
                    ...
                    Swal.fire(
                        "<p style='font-size: 14px;'>Changes Saved Successfully</p>",
                        "",
                        "success"
                    );
                    app.getAllDVDAudios();
...
.custom-checkbox-else .custom-control-input:checked~.custom-control-label::after {
