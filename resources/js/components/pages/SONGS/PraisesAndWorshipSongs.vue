                    ...
                    <div class="row justify-content-center">
                        <table class="table table-sm present-tense-table">
                            ...
                            >
                                ...
                                <td>
                                    {{
                                        praisesAndWorshipSong.created_at
                                            | myDate
                                    }}
                                </td>
                                <td>
                                    <a
                                        href="#"
                                        @click="
                                            updateSong(praisesAndWorshipSong)
                                        "
                                    >
                                        <i
                                    ...
                                    <a
                                        href="#"
                                        @click="
                                            deleteSong(praisesAndWorshipSong.id)
                                        "
                                ...
                                >
                                    ...
                                    <div class="text-center">
                                        <p
                                            ...
                                            "
                                        >
                                            Praises And Worship Songs Template,
                                            or if you prefer
                                        </p>
