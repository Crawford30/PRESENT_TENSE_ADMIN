    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="staff-card shadow-sm table-padding">
                <div class="row justify-content-center">
                  ...
                  praisesAndWorshipSong, index
                ) in praisesAndWorshipSongs.results" :key="praisesAndWorshipSong.id + '_' + index">
                            <td>{{ index + 1 }}</td>
                            ...
                            <td>
                                ...
                                <a href="#" @click="deleteSong(praisesAndWorshipSong.id)" style="margin-left: 8px">
                                    <i class="far fa-trash-alt" style="color: #999; font-size: 18px"></i>
                                </a>

                                <a href="#" @click="viewSongDetail(praisesAndWorshipSong)" style="margin-left: 8px">
