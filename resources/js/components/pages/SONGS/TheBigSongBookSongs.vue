            ...
            <div class="staff-card shadow-sm table-padding">
                <div class="row justify-content-center">
                    <table class="table table-sm present-tense-table">
                        ...
                        <tr v-for="(
                  theBigSongBookSong, index
                ) in theBigSongBookSongs.results" :key="theBigSongBookSong.id + '_' + index">
                            <td>{{ index + 1 }}</td>
                            <td>{{ theBigSongBookSong.song_number }}</td>
                            <td class="text-left">
                                {{ theBigSongBookSong.song_title }}
                            </td>
                            <td>{{ theBigSongBookSong.created_at | myDate }}</td>
                            <td>
                                <a href="#" @click="updateSong(theBigSongBookSong)">
                                    <i class="fas fa-pencil-alt" style="color: #999; font-size: 18px"></i>
                                </a>

                                <a href="#" @click="deleteSong(theBigSongBookSong.id)" style="margin-left: 8px">
                                    <i class="far fa-trash-alt" style="color: #999; font-size: 18px"></i>
                                </a>

                                <a href="#" @click="viewSongDetail(theBigSongBookSong)" style="margin-left: 8px">
