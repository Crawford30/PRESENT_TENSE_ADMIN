                    ...
                    <div class="row justify-content-center">
                        <table class="table table-sm present-tense-table">
                            ...
                            <tr
                                ...
                                ) in theBigSongBookSongs.results"
                            ...
                            >
                                ...
                                <td>
                                    {{ theBigSongBookSong.created_at | myDate }}
                                </td>
                                <td>
                                    <a
                                        href="#"
                                        @click="updateSong(theBigSongBookSong)"
                                    >
                                        <i
                                    ...
                                    <a
                                        href="#"
                                        @click="
                                            deleteSong(theBigSongBookSong.id)
                                        "
                                    ...
                                    <a
                                        href="#"
                                        @click="
                                            viewSongDetail(theBigSongBookSong)
                                        "
                                        style="margin-left: 8px"
                                    >
                                        <i
                                ...
                                >
                                    ...
                                    <div class="text-center">
                                        <p
                                            ...
                                            "
                                        >
                                            The Big Song Book Songs Template, or
                                            if you prefer
                                        </p>
