            ...
            <div class="staff-card shadow-sm table-padding">
                <div class="row justify-content-center">
                    <table class="table table-sm present-tense-table">
                        ...
                        <tr v-for="(
                                    tenMajorSong, index
                                ) in tenMajorSongs.results" :key="tenMajorSong.id + '_' + index">
                            <td>{{ index + 1 }}</td>
                            <td>{{ tenMajorSong.song_number }}</td>
                            <td class="text-left">
                                {{ tenMajorSong.song_title }}
                            </td>
                            ...
                            <td>
                                ...
                                <a href="#" @click="deleteSong(tenMajorSong.id)" style="margin-left: 8px">
                                    <i class="far fa-trash-alt" style="color: #999; font-size: 18px"></i>
                                </a>

                                <a href="#" @click="viewSongDetail(tenMajorSong)" style="margin-left: 8px">
                ...
                <div class="modal-body py-4">
                            ...
                            <div v-if="!hasFile" id="drop-area" class="drag-drop-area px-5 py-3" style="margin-left: 0; margin-right: 0">
                                ...
                                <div class="text-center">
                                    <p style="
                                                ...
                                                font-size: 12px;
                                            ">
                                        God Ten Major Songs Template, or if
                                        you prefer
                                    </p>
                                    <div class="position-relative">
                                        <button type="button" class="btn btn-primary position-relative" style="
                                                    font-size: 12px;
                                                    margin-top: 5px;
                                                ">
                                            Browse
                    ...
                    <div class="text-center mt-2">
                        <button :disabled="file === null || isProcessing" @click="uploadFile" type="button" class="present-tense-btn present-tense-primary">
                            <span>
                                <i v-if="isProcessing" class="fa fa-spinner fa-spin">
                                </i>
                                UPLOAD</span>
                        </button>
                    </div>
