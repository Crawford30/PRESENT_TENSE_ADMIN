                ...
                <div class="staff-card shadow-sm table-padding">
                    <div class="row justify-content-center">
                        <table class="table table-sm present-tense-table">
                            ...
                            <tr
                                v-for="(
                                    variousTongueSong, index
                                ) in variousTongueSongs.results"
                            ...
                            >
                                ...
                                <td>
                                    {{ variousTongueSong.created_at | myDate }}
                                </td>
                                <td>
                                    <a
                                        href="#"
                                        @click="updateSong(variousTongueSong)"
                                    >
                                        <i
                                    ...
                                    <a
                                        href="#"
                                        @click="
                                            deleteSong(variousTongueSong.id)
                                        "
                                    ...
                                    <a
                                        href="#"
                                        @click="
                                            viewSongDetail(variousTongueSong)
                                        "
                                        style="margin-left: 8px"
                                    >
                                        <i
                                ...
                                >
                                    ...
                                    <div class="text-center">
                                        <p
                                            ...
                                            "
                                        >
                                            The Songs In Various Tongues
                                            Template, or if you prefer
                                        </p>
