                ...
                <div class="staff-card shadow-sm table-padding">
                    <div class="row justify-content-center">
                        <table class="table table-sm present-tense-table">
                            ...
                            <tr
                                v-for="(
                                    presentTenseSong, index
                                ) in presentTenseSongs.results"
                            ...
                            >
                                ...
                                <td>
                                    {{ presentTenseSong.created_at | myDate }}
                                </td>
                                <td>
                                    <a
                                        href="#"
                                    ...
                                    <a
                                        href="#"
                                        @click="
                                            viewSongDetail(presentTenseSong)
                                        "
                                        style="margin-left: 8px"
                                    >
                                        <i
                                ...
                                >
                                    ...
                                    <div class="text-center">
                                        <p
                                            ...
                                            "
                                        >
                                            The Present Tense Songs Template, or
                                            if you prefer
                                        </p>
