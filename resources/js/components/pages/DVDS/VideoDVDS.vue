            ...
            <div class="col-md-3">
                <div class="btn-group add-new-dropdown" style="width: 100%">
                    <div class="btn-group w-100" role="group">
                        <button type="button" class="btn btn-primary" @click="showUploadVideo">
                            Upload Video DVD
                        </button>
                    </div>
                </div>
            ...
            <div class="staff-card shadow-sm table-padding">
                <div class="row justify-content-center">
                    <table class="table table-sm present-tense-table">
                        ...
                        <tr v-for="(dvdVideo, index) in dvdVideos.results" :key="dvdVideo.id + '_' + index">
                            <td>{{ index + 1 }}</td>
                    ...
                    dvdVideo.video_dvd_name
                            ...
                            <td>
                                ...
                                <a @click.prevent="deleteVideoDVD(dvdVideo.id)" href="#" style="margin-left: 8px">
                ...
                <form enctype="multipart/form-data" id="videos-form" method="post">
                    <div class="modal-body px-4 mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <input required v-model="selectedVideo.video_dvd_name" name="video_dvd_name" class="form-control" placeholder="Video DVD Name" type="text" />
                        </div>

                        <label for="">Video DVD File</label>
                        <DropFile ref="dropFile" inline-template v-cloak>
                            <div class="text-muted">
                                <div v-if="!hasFile" v-bind:style="{ backgroundImage: backgroundImage }" v-on:drop.prevent="dragDrop" v-on:dragover.prevent="dragOver" class="drag-drop-area px-5 py-3" style="margin-left: 0; margin-right: 0">
                        ...
                        ">
                              ...
                              opacity: 0;
                              cursor: pointer;
                            " accept="video/mp4,video/x-m4v,video/*" id="videoFile" class="opactiy-none" @change="fileChanged" name="file" ref="FileInput" />
                                            </button>
                                        </div>
                                    </div>
                                </div>
                  ...
                  /> -->
                            ...
                            <input v-model="selectedVideo.creation_date" name="creation_date" required class="form-control" placeholder="e.g 2019-12-30 for 30-DEC-2019" type="text" />
                        </div>

                        <input hidden :value="selectedVideo.id" name="video_id" type="text" />
                        <div class="form-group text-center">
                            <button @click.prevent="uploadVideo" :disabled="isProcessing" class="present-tense-btn present-tense-primary px-6 mt-3 mb-3">
                                <span>
    ...
    <div class="modal" id="showVideo">
        <div class="modal-dialog modal-lg">
            <div v-if="displayVideo" class="modal-content px-2 py-2">
                ...
                <!-- {{selectedVideo}} -->
                <iframe id="vid-show" autoplay="false" width="100%" height="400px" :src="
